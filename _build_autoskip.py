...
OWNER, REPO, WF, REF = 'yxh41', 'DYYY', 'build.yml', 'feat-auto-skip-ad-chapter'
OUT_DIR = r'C:\Users\hxy24\WorkBuddy\dyyy\DYYY_build_autoskip'
# 确认产物确实是本次代码（正式构建无探针宏，只验实现特征串）
VERIFY_NEEDLES = [b'adChapterAutoSkipIndexArray', b'DYYYAutoSkipAdChapter']
